...
Agent Identity Node is a small Rust substrate for local agent authorization. It gives the AI agent runtime a solidified cryptographic node identity, encrypted key storage, bootstrap authentication, signed scoped capability grants, and explicit capability policies.
